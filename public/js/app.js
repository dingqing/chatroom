$(function () {
    $(".message .send").click(function () {
        ...
        var html = '<div class="col-xs-10 col-xs-offset-2 msg-item ">'
            ...
            + '<div class="avatar">'
            + '<img src="http://dingqing.cn/uploads/avatar/71efddad30a9d182083721dfcfc6c6ea.jpg" width="30" height="30" class="img-circle">'
            + '</div>'
            + '</div>'
...
function appendUser(name, avatr, fid) {
    var html = ' <div class="list-group-item user-item">'
        + '<div class="avatar">'
        + '<img src="http://dingqing.cn/uploads/avatar/71efddad30a9d182083721dfcfc6c6ea.jpg" width="30" height="30" class="img-circle">'
        + '</div>'
